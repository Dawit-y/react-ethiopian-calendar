...
export const convertToEthiopian = (dateString) => {
	...
	const ethiopianDate = toEthiopian(year, month, day);

	return {
		year: ethiopianDate[0],
		month: ethiopianDate[1],
		day: ethiopianDate[2],
		monthName: etMonths[ethiopianDate[1] - 1],
		monthNameEnglish: etMonthsEnglish[ethiopianDate[1] - 1],
	};
};
