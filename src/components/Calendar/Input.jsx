...
const Input = forwardRef(
	(
		...
		const formatDateRange = () => {
			if (!dateRange || !selectedDateRange.startDate) {
				return "";
			}
			...
			const startDate = toEthiopianDate(selectedDateRange.startDate);
			let displayText = startDate;

			if (selectedDateRange.endDate) {
				const endDate = toEthiopianDate(selectedDateRange.endDate);
				displayText += ` - ${endDate}`;
			} else {
